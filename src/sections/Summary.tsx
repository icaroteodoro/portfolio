    ...
    return (
        <section id="sumary" className="container flex flex-col-reverse md:flex-row items-start md:items-center text-white py-20 lg:py-52">
            <div className=" w-full md:w-3/5 mt-12">
                <h1 className="font-extrabold w-full text-4xl lg:text-8xl font-poppins">Ícaro Teodoro</h1>
                <h2 className="font-extrabold text-2xl lg:text-5xl mt-2 font-poppins">Desenvolvedor Fullstack</h2>
